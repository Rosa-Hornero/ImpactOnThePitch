...
def render_burnley_tab():
    ...
    with cola:
        st.image("static/images/escudos/burnley_logo.png", caption="Logo of Burnley", width=150)

    # Columna derecha: Historia del equipo
    with colb:
        st.write("""
            **Burnley Football Club**  
            Established in 1882, Burnley is a historic football club with deep roots in English football. Known as "The Clarets," the team plays its home matches at Turf Moor, one of the oldest football grounds still in use. Burnley is renowned for its hardworking and resilient style of play, as well as its loyal and passionate fan base. The club has achieved notable success, including winning league titles and maintaining a proud presence in the top tiers of English football. Burnley continues to embody the spirit of community and tradition in the modern game.
        """)
    ...
    # Datos Burnley
    burnley_data = data[data['Team Name'] == 'Burnley']


    # Filtrar por temporada
    seasons = burnley_data['Season'].unique()  
    selected_season = st.selectbox("Select a Season", options=seasons)
    fil_seas_data = burnley_data[burnley_data['Season'] == selected_season]
    ...
    if selected_player == None:
        ...
        st.write(f"Here you can see the general injury metrics of **Burnley for the session {selected_season}**. You can see the **total number of injured players**, the **average injury time** and the **average age** of the injured players. You can also view different graphs to see the **most frequent type of injury** and the **most affected positions**. Also included is a **calendar** where you can see **all the injuries** of the team this season.")
