...
def render_newcastle_tab():
    st.title('🪶 Newcastle United')
    ...
    with cola:
        st.image("static/images/escudos/newcastle_logo.png", caption="Logo of Newcastle United", width=150)

    # Columna derecha: Historia del equipo
    with colb:
        st.write("""
                **Newcastle United Football Club**  
                Established in 1892, Newcastle United is one of England's most iconic football clubs. Known as "The Magpies," the team plays its home matches at the historic St James' Park in the heart of Newcastle. With their distinctive black and white striped jerseys, Newcastle has a proud history that includes multiple league titles and FA Cup triumphs. The club is celebrated for its passionate supporters and its strong ties to the local community, embodying the spirit of the North East.
            """)
    ...
    # Datos Newcastle
    newcastle_data = data[data['Team Name'] == 'Newcastle']
    ...
    if selected_player == None:
        ...
        st.write(f"Here you can see the general injury metrics of **Newcastle United for the session {selected_season}**. You can see the **total number of injured players**, the **average injury time** and the **average age** of the injured players. You can also view different graphs to see the **most frequent type of injury** and the **most affected positions**. Also included is a **calendar** where you can see **all the injuries** of the team this season.")
