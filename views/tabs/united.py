...
def render_united_tab():
    ...
    with cola:
        st.image("static/images/escudos/manutd_logo.png", caption="Logo of Manchester United", width=150)

    # Columna derecha: Historia del equipo
    with colb:
        st.write("""
                **Manchester United Football Club**  
                Established in 1878, Manchester United is one of the most successful and globally recognized football clubs in the world. Known as "The Red Devils," the team plays its home matches at the iconic Old Trafford stadium. Renowned for their attacking style of play and rich history, Manchester United has won numerous league titles, FA Cups, and European trophies. With a massive fan base and a legacy of legendary players and managers, the club continues to inspire football fans around the globe.
            """)
    ...
    # Datos Newcastle
    newcastle_data = data[data['Team Name'] == 'Man United']


    # Filtrar por temporada
    seasons = newcastle_data['Season'].unique()  
    selected_season = st.selectbox("Select a Season", options=seasons)
    fil_seas_data = newcastle_data[newcastle_data['Season'] == selected_season]
    ...
    if selected_player == None:
        ...
        st.write(f"Here you can see the general injury metrics of **Manchester United for the session {selected_season}**. You can see the **total number of injured players**, the **average injury time** and the **average age** of the injured players. You can also view different graphs to see the **most frequent type of injury** and the **most affected positions**. Also included is a **calendar** where you can see **all the injuries** of the team this season.")
